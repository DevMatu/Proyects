...
// Definición de la estructura Carta, se crea como un nuevo tipo de dato, el dato "Carta". "Carta" representa una carta de un palo y su valor.
struct Carta {
    string palo;
    string valor;
};

// Función para inicializar la baraja con 20 cartas. & significa que recibe al vector por referencia. esto permite modificar el vector dentro de la funcion.
...
// Función para repartir cartas a dos jugadores
void repartirCartas(Carta baraja[], Carta jugador1[], Carta jugador2[], int TAM) {
    ...
    for (int i = 0; i < cartasPorJugador; i++) {
        ...
        int indice = rand() % TAM; // Generar un índice aleatorio entre 0 y el tamaño de la baraja(menos 1 = 0 - 19), y lo guarda en la variable "indice".
...
int TirarDado(){
    ...
    return (rand() % 6) + 1; //genera un numero aleatorio entre el 1 y el tamaño elegido, en este caso 6 y retorna su valor;
}
...
//funcion dado 2.
void funcionDado2(Carta jugador2[], int ce, Carta baraja[],bool bloqueo[]){
...
//funcion dado 6.
void funcionDado6(int ce, int turno, Carta jugador1[], Carta jugador2[], Carta baraja[], bool BloqueoJ1[], bool BloqueoJ2[], bool roboj1, bool roboj2){
...
void creditos() {
	...
	cout << " " << " +"<<"============================+" << endl;
	cout << " " << " |                            |"<< endl;
    cout << " " << " |"<< "+ HECHO POR: LOS APROBADOS"; cout << "  |" << endl;
    cout << " " << " |                            |"<< endl;
...
char nombres(char vNombre1[], char vNombre2[], int tam) {
...
int main() {
    ...
    system("cls");
    bool partida=true, roboj1 = false, roboj2 = false, SaltoTurnoJ16=false, SaltoTurnoJ26=false;
        ...
        case 1:
            ...
            if(c=='N' || c=='n'){
                ...
                if(c=='s' || c=='S'){
                    ...
                    if (jugador1[0].valor == "10" && jugador1[1].valor == "J" && jugador1[2].valor == "Q" && jugador1[3].valor == "K" && jugador1[4].valor == "A") {
                        cout << "Las cartas del Jugador 1 están ordenadas. Mezclando y repartiendo nuevamente." << endl;
                        inicializarBaraja(baraja);
                        repartirCartas(baraja, jugador1, jugador2, TAM);
                    }
                    else if (jugador2[0].valor == "10" && jugador2[1].valor == "J" && jugador2[2].valor == "Q" && jugador2[3].valor == "K" && jugador2[4].valor == "A") {
                        cout << "Las cartas del Jugador 2 están ordenadas. Mezclando y repartiendo nuevamente." << endl;
                        inicializarBaraja(baraja);
                        repartirCartas(baraja, jugador1, jugador2, TAM);
                    }
            ...
            while(partida){
                ...
                switch(dado){
                    ...
                    case 6:
                        ...
                        cout <<  "4 Se eligen dos cartas del propio corral (1-5) y se intercambian entre sí." << endl;
                        cout <<  "5 Bloquear una carta del corral " << endl;
                        cout <<  "6 Pasar de turno" << endl;
                        cin >> ce;
                        funcionDado6(ce, turno, jugador1, jugador2, baraja, BloqueoJ1, BloqueoJ2, roboj1, roboj2);
